...
from .views import AcabamentoCreate, ModeloPerfilCreate,ModeloPerfilPuxadorCreate, ModeloPuxadorCreate, ModeloDivisorCreate, ModeloDivisoriaAmbienteCreate, ModeloVidroCreate, TipoCreate, PerfilCreate, PerfilPuxadorCreate, PuxadorCreate
from .views import AcabamentoUpdate, ModeloPerfilUpdate,ModeloPerfilPuxadorUpdate, ModeloPuxadorUpdate, ModeloDivisorUpdate, ModeloDivisoriaAmbienteUpdate, ModeloVidroUpdate, TipoUpdate, PerfilUpdate, PerfilPuxadorUpdate, PuxadorUpdate
from .views import AcabamentoDelete, ModeloPerfilDelete,ModeloPerfilPuxadorDelete, ModeloPuxadorDelete, ModeloDivisorDelete, ModeloDivisoriaAmbienteDelete, ModeloVidroDelete, TipoDelete, PerfilDelete, PerfilPuxadorDelete, PuxadorDelete
from .views import AcabamentoList, TipoList, PerfilList, PerfilPuxadorList, PuxadorList
