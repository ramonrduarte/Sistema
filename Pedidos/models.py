...
class Pedido(models.Model):
    ...
    largura = models.DecimalField(max_digits=6, decimal_places=3, blank=False, null=False)
    altura = models.DecimalField(max_digits=6, decimal_places=3, blank=False, null=False)
